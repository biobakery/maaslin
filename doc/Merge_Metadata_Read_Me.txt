...
python merge_metadata.py metadata_input_file.tsv < otu_table_input_file.pcl > output_file.pcl
...
python src/merge_metadata.py input/for_merge_metadata/maaslin_demo_metadata.tsv < input/for_merge_metadata/maaslin_demo_measurements.pcl > input/maaslin_demo.pcl
...
5. An example file is found at input/for_merge_metadata/maaslin_demo_metadata.tsv
