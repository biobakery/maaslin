...
An example of the expected files are found in this project in the directory maaslin/inst/extdata/for_merge_metadata
An example of how to run the command on the example files is as follows (when in the maaslin folder in a terminal):
python exec/merge_metadata.py inst/extdata/for_merge_metadata/maaslin_demo_metadata.metadata < inst/extdata/for_merge_metadata/maaslin_demo_measurements.pcl > maaslin_demo.pcl
...
5. An example file is found at inst/extdata/for_merge_metadata/maaslin_demo_metadata.metadata
...
4. An example file is found at inst/extdata/for_merge_metadata/maaslin_demo_measurements.pcl
